...
public class ServiceAdapter extends ArrayAdapter<Service> {
    ...
    private int total;
    public ServiceAdapter(@NonNull Context context, int resource, List<Service> listService, TextView totalService) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.service_item, null);
