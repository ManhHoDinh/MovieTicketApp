        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dateBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        if(listTime == null){
                            ...
                            if(prevType != cinemaName){
                                if(prevView != null){
                                    ...
                                    Log.e("f", String.valueOf(prevPosition) + " " + dateBtn.getText());
                                    btn.setBackgroundTintList(ColorStateList.valueOf(R.drawable.bg_tabview_button));
                    ...
                    dateBtn.setBackgroundTintList(ColorStateList.valueOf(R.drawable.second_gradient));
//                        dateBtn.setBackgroundColor(R.drawable.second_gradient);
        ...
        void Binding(){
            if(checkedPosition != getAdapterPosition())
                dateBtn.setBackgroundTintList(ColorStateList.valueOf(R.drawable.bg_tabview_button));
//            }
       //
                else dateBtn.setBackgroundTintList(ColorStateList.valueOf(R.drawable.bg_tabview_button));
        }
    }
    @NonNull
    @Override
